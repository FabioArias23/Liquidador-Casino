...
const SUPERADMIN_ID = userId("00000000-0000-0000-0000-0000000000a1");
const OPERADOR_ID = userId("00000000-0000-0000-0000-0000000000b1");
const SUPERVISOR_ID = userId("00000000-0000-0000-0000-0000000000b2");
const ADMIN_ID = userId("00000000-0000-0000-0000-0000000000b3");

const CASINO_DEMO_ID = tenantId("00000000-0000-0000-0000-0000000000c1");

const MEMBER_OPERADOR_ID = memberId("00000000-0000-0000-0000-0000000000d1");
const MEMBER_SUPERVISOR_ID = memberId("00000000-0000-0000-0000-0000000000d2");
const MEMBER_ADMIN_ID = memberId("00000000-0000-0000-0000-0000000000d3");

const CBU_DEMO_ID = cbuAccountId("00000000-0000-0000-0000-0000000000e1");
